export const CASES = [
  {
    ...
    issues: [
      ...
      "Can national security justify curtailment of the right to privacy?",
      "Is the Digital Surveillance Act, 2024 constitutionally valid?"
    ],
    precedents: [
  ...
  },
  {
    ...
    issues: [
      ...
      "Can a state invoke force majeure to escape commercial obligations?",
      "What are the remedies available under the Arbitration and Conciliation Act, 1996?"
    ],
    precedents: [
      "Energy Watchdog v. CERC (2017) 14 SCC 80",
      "Satyabrata Ghosh v. Mugneeram Bangur (1954) SCR 310",
      "Alopi Parshad v. Union of India (1960) 2 SCR 793"
    ],
  ...
  },
  {
    ...
    issues: [
      ...
      "Is there a constitutional right to know the source of political funding?",
      "Does the scheme violate the principle of free and fair elections?"
    ],
    precedents: [
  ...
  },
  {
    ...
    issues: [
      ...
      "Is AIIMS liable under consumer protection laws?",
      "Can professionals be held criminally liable for gross negligence under Section 304A IPC?"
    ],
    precedents: [
  ...
  },
  {
    ...
    issues: [
      ...
      "Can economic benefits justify environmental risks in ecologically sensitive areas?",
      "What is the scope of judicial review over environmental clearance decisions?"
    ],
    precedents: [
